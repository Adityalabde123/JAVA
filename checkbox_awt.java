//this is an example that when we click on one check box it directly select another related checkbox

import java.awt.*;
import java.awt.event.*;
 class checkbox_awt extends Frame implements ItemListener {
   ...
   checkbox_awt()
   {
      ...
      c3=new Checkbox("BCOM",cg1,false);
      c4=new Checkbox("M.com",cg2,false);
